...
Ancestry follows the normal rules in the *Core Rulebook*, with minor modifications to adapt to the languages of Golarion.  The Pathfinder society does not permit Half-elves or Half-orcs of ancestries other than Human.
  ...
  Home Region
    This is also the stage at which you should choose your character’s home region (Core Rulebook 420-429), and in the case of human characters, your ethnicity. (Core Rulebook 430-431).  Home regions fulfill :term:`Access` requirements and prerequisites for character options. See Rarity for more information.
...
Another way to join the Pathfinder Society is via a field commission from another agent or a :term:`Venture-Captain <Venture-Captain (in-game)>` of the Society. Characters who received a field commission have fewer connections to the Society’s  membership, and receive fewer gifts, but have fewer obligations to the society and thus more downtime.  

  Pathfinder Training
    Each character should choose one of the following: Spells, Scrolls Swords, Generalist, or Field Commission. Each of these choices grants a bonus lore at first level, and a bonus skill feat at 5th level. Each Pathfinder Training (except Field Commission) also grants a :ref:`bonus consumable <School Consumables>` at the beginning of each mission.
